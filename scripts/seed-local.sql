...
INSERT INTO shift_plans (id, group_id, name, start_date, end_date, opening_time, closing_time, slot_minutes, default_required_count, notes, status, created_by) VALUES
  ('seed-yakiniku-plan-august-first', 'seed-group-yakiniku', '焼肉店 8月前半シフト', '2026-08-01', '2026-08-15', '14:00', '24:00', 60, 1,
   '店長は配置対象外。時間帯ごとに担当別の勤務枠を作り、担当範囲・希望差分・体制不足を確認する。', 'draft', 'yakiniku-manager@local.test');
...
-- 焼肉店の担当別ガイド。内容は架空のデモ例で、公開済みページとしてメンバーと本人用AIから検索できます。
...
INSERT INTO shift_assignments (id, slot_id, user_email) VALUES
  ('yakiniku-assignment-0801-1400-hall', 'yakiniku-slot-2026-08-01-1400-hall', 'yakiniku-submanager@local.test'),
  ('yakiniku-assignment-0801-1400-meat', 'yakiniku-slot-2026-08-01-1400-meat', 'yakiniku-kitchen-a@local.test'),
  ('yakiniku-assignment-0801-1700-hall', 'yakiniku-slot-2026-08-01-1700-hall', 'yakiniku-submanager@local.test'),
  ...
  ('yakiniku-assignment-0801-1900-waiting', 'yakiniku-slot-2026-08-01-1900-waiting', 'yakiniku-hall-c@local.test'),
