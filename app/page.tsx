...
export default function Home() {
  ...
  function openGroupTarget(groupId: string, target: "basic" | "requests" | "shift" | "members") { setMenuGroupId(groupId); if (target === "basic") setGroupPreferencesOpen(true); if (target === "members") setGroupsOpen(true); if (target === "requests") setShiftRequestsOpen(true); if (target === "shift") setShiftOpen(true); }
  ...
  return <main className="shell">
    ...
    <GroupMenu groups={groups} onApplications={() => { setMenuGroupId(undefined); setGroupsOpen(true); }} onBasic={(groupId) => openGroupTarget(groupId, "basic")} onRequests={(groupId) => openGroupTarget(groupId, "requests")} onRoster={() => setShiftRosterOpen(true)} onShiftBuilder={(groupId) => openGroupTarget(groupId, "shift")} onMembers={(groupId) => openGroupTarget(groupId, "members")} />
