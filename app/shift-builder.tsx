...
export default function ShiftBuilder({ initialGroupId }: { initialGroupId?: string }) {
  ...
  return <section className="shift-builder-card">
    <div className="shift-builder-head"><div><p className="eyebrow">SHIFT PLANNER</p><h2>シフト作成</h2><p>条件から勤務枠を作り、表でメンバーを割り当てます。</p></div>{detail && <button className="ghost-button" onClick={() => setDetail(null)}>新しい計画</button>}</div>
    {!detail ? <>
