...
export default function CalendarSubscriptionPanel({ groupId }: { groupId: string }) {
  ...
  return <section className="calendar-subscription-panel">
    ...
    <details className="subscription-help"><summary>登録方法</summary><p><strong>Googleカレンダー</strong>の「他のカレンダー」から「URLで追加」を選び、購読URLを貼り付けます。</p><p><strong>iPhone</strong>は「設定」→「カレンダー」→「アカウント」→「アカウントを追加」→「その他」→「照会するカレンダーを追加」から登録します。</p><p>カレンダー側の更新間隔やキャッシュにより、シフト変更がすぐ反映されない場合があります。</p></details>
