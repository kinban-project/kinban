...
export default function MonthlyWorkPanel({ groupId, manager }: { groupId: string; manager: boolean }) {
  ...
  async function review(email: string, action: "approve" | "reject" | "reopen") {
